...
<form method="post" action="submit_librarian.php"><fieldset>
	<legend><h3>Register New Librarian</h3></legend>
	<br>
	...
	<br><br>
	Enter Your Username :
	<input type="text" name="username_l" required>
	<br><br>
	Enter Your Password :
	<input type="Password" name="password_l" required> &nbsp; 
	<input type="Password" name="passwordconfirm_l" placeholder="Confirm Password" required>
	<?php
