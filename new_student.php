...
<fieldset>
	<legend><h3>Register New Student</h3></legend>
	<br>
	...
	<br><br>
	Enter Your Username :
	<input type="text" name="username_s" required>
	<br><br>
	Enter Your Password :
	<input type="Password" name="password_s" required> &nbsp; 
	<input type="Password" name="passwordconfirm_s" placeholder="Confirm Password" required>
			<?php
